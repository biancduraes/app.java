...
Dá pra criar tarefas, atualizar o status e excluir quando não precisa mais. Ele salva tudo num arquivo CSV, então funciona sem precisar de banco de dados. 
Projeto legal para treinar Java, manipulação de arquivos e HTTP.

//Idéia             
Uma ideia pra evoluir seria criar um sistema mais completo, com interface gráfica, banco de dados de verdade e login de usuário. Também podia ter filtros, relatórios e histórico de mudanças.
